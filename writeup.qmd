...
# Shiny app
Shiny app: To make our findings more interactive, we developed a Shiny app that includes all the plots and maps we created. It allows users to explore the 
...
rate is special in that you can choose different time intervals to view the corresponding map.
```{python}
